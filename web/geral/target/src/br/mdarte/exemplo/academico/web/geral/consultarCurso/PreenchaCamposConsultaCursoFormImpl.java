...
public class PreenchaCamposConsultaCursoFormImpl
    extends br.mdarte.exemplo.academico.accessControl.LoginFormImpl
    implements java.io.Serializable
        , br.mdarte.exemplo.academico.web.geral.consultarCurso.ConsultaCursoForm
{
    ...
    private java.util.Collection cursos = null;
    ...
    public PreenchaCamposConsultaCursoFormImpl(){
    ...
    /**
     * Resets the given <code>cursos</code>.
     */
    ...
    {
        this.cursos = (cursos == null) ? null : java.util.Arrays.asList(cursos);
    }
     ...
     *
     * @see br.mdarte.exemplo.academico.web.geral.consultarCurso.PreenchaCamposConsultaCursoFormImpl#getCursos
     */
    public java.lang.Object[] getCursosAsArray()
    {
        return (cursos == null) ? null : cursos.toArray();
    }
    ...
    public String getOperationModeKey(){
        return "geral/ConsultaCursoUC/ConsultaCursoUC.do";
    }
	
	public String getActionPath(){
		return "/ConsultaCursoUC/PreenchaCamposConsultaCurso.action";
    }
