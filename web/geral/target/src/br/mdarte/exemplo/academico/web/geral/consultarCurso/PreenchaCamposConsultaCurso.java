...
public class PreenchaCamposConsultaCurso extends br.mdarte.exemplo.academico.accessControl.Login2
{
	...
	public String particularExecute() throws Exception
	{
		...
		urlCasoDeUso = "/ConsultaCursoUC/PreenchaCamposConsultaCurso";
		...
		{
			if(getInvalidatePageControlCounter(request).get("ConsultaCursoUC.PreenchaCampos") != null && request.getParameter("invalidatePageControlCounter") != null && !(((Integer)getInvalidatePageControlCounter(request).get("ConsultaCursoUC.PreenchaCampos")).equals(Integer.valueOf(request.getParameter("invalidatePageControlCounter")))))
			{
		...
		PreenchaCamposConsultaCursoFormImpl form = new PreenchaCamposConsultaCursoFormImpl();

		form.setCodigo(this.codigo);
		form.setCursos(this.cursos);
		form.setIdCurso(this.idCurso);
		form.setNome(this.nome);

		final PreenchaCamposConsultaCursoFormImpl specificForm = (PreenchaCamposConsultaCursoFormImpl)form;
		...
		try
		{
			request.getSession().setAttribute(Constantes.ACAO_ATUAL, "/ConsultaCursoUC/PreenchaCamposConsultaCurso.action");
			...
			forward = _consultandoCurso(form);

		}//fim try
		catch (java.lang.Exception exception)
		{
			Object formObj = org.andromda.presentation.bpm4struts.PageSessionObjectUtil.getPageForm(request, "ConsultaCursoUC.PreenchaCampos");
	 ...
	 * 
	 */
	private String _consultandoCurso(org.apache.struts.validator.ValidatorForm form) throws java.lang.Exception
	{
		String forward = null;
		String redirect ="";
		request.getSession().setAttribute(org.apache.struts.Globals.MESSAGE_KEY, new org.apache.struts.action.ActionMessages());
	
		ConsultaCursoControleFactory.getConsultaCursoControleInstance().consultaCurso((PreenchaCamposConsultaCursoFormImpl) form, new Struts2ViewContainer(this, request, response));
		...
		getInvalidatePageControlCounter(request).put("ConsultaCursoUC.ResultadoConsulta", ((Integer)getInvalidatePageControlCounter(request).get("ConsultaCursoUC.ResultadoConsulta")).intValue() + 1);

		org.andromda.presentation.bpm4struts.PageSessionObjectUtil.setPageSO(request, new org.andromda.presentation.bpm4struts.FormSessionObject("ConsultaCursoUC.ResultadoConsulta", form, 5));
