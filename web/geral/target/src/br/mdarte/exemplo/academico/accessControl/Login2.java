...
public abstract class Login2 extends ActionSupport implements ServletRequestAware, ServletResponseAware
{
...
//				{
//					url = "https://" + (request.getServerName() + ":" + request.getSession().getServletContext().getAttribute("httpsPort") + "//sistemaacademico" + forward.getPath()).replaceAll("//", "/");
//				}
//				else
//				{
...
//			request.getSession().invalidate();
	...
	private org.apache.struts.action.ActionMessages getExceptionHandlerErrors(HttpServletRequest request)
	{
		org.apache.struts.action.ActionMessages errors =
			(org.apache.struts.action.ActionMessages)request.getAttribute("org.andromda.bpm4struts.errormessages");
		if (errors == null)
		{
