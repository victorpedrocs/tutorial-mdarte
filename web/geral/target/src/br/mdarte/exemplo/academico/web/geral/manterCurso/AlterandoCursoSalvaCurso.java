...
public class AlterandoCursoSalvaCurso extends br.mdarte.exemplo.academico.accessControl.Login2
{
	...
	public String particularExecute() throws Exception
	{
		...
		{
			if(getInvalidatePageControlCounter(request).get("MantemCursoUC.AlterandoCurso") != null && request.getParameter("invalidatePageControlCounter") != null && !(((Integer)getInvalidatePageControlCounter(request).get("MantemCursoUC.AlterandoCurso")).equals(Integer.valueOf(request.getParameter("invalidatePageControlCounter")))))
			{
	...
	private String _salvandoCurso(org.apache.struts.validator.ValidatorForm form) throws java.lang.Exception
	{
		...
		MantemCursoControleFactory.getMantemCursoControleInstance().salvaCurso((AlterandoCursoSalvaCursoFormImpl) form, new Struts2ViewContainer(this, request, response));
