...
public class PreenchaCamposConsultaEstudanteFormImpl
    extends br.mdarte.exemplo.academico.accessControl.LoginFormImpl
    implements java.io.Serializable
        , br.mdarte.exemplo.academico.web.geral.consultarEstudante.ConsultaEstudanteForm
{
    ...
    public PreenchaCamposConsultaEstudanteFormImpl(){

    }

    /**
     * Resets the given <code>estudantes</code>.
     */
    ...
    {
        this.estudantes = (estudantes == null) ? null : java.util.Arrays.asList(estudantes);
    }
     ...
     *
     * @see br.mdarte.exemplo.academico.web.geral.consultarEstudante.PreenchaCamposConsultaEstudanteFormImpl#getEstudantes
     */
    ...
    public String getOperationModeKey(){
        return "geral/ConsultaEstudanteUC/ConsultaEstudanteUC.do";
    }
	
	public String getActionPath(){
		return "/ConsultaEstudanteUC/PreenchaCamposConsultaEstudante.action";
    }
