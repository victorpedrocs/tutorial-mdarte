...
public class DetalhaCursoUC extends br.mdarte.exemplo.academico.accessControl.Login2
{
	...
	public String particularExecute() throws Exception
	{
		...
		urlCasoDeUso = "/DetalhaCursoUC/DetalhaCursoUC";
		...
		DetalhaCursoUCFormImpl form = new DetalhaCursoUCFormImpl();

		form.setCodigo(this.codigo);
		form.setIdCurso(this.idCurso);
		form.setNome(this.nome);

		final DetalhaCursoUCFormImpl specificForm = (DetalhaCursoUCFormImpl)form;
		...
		{
			Object formObj = org.andromda.presentation.bpm4struts.PageSessionObjectUtil.getPageForm(request, "DetalhaCursoUC");
	...
	private String _carregandoCurso(org.apache.struts.validator.ValidatorForm form) throws java.lang.Exception
	{
		...
		DetalhaCursoControleFactory.getDetalhaCursoControleInstance().carregaCurso((DetalhaCursoUCFormImpl) form, new Struts2ViewContainer(this, request, response));
		...
		org.andromda.presentation.bpm4struts.PageSessionObjectUtil.setPageSO(request, new org.andromda.presentation.bpm4struts.FormSessionObject("DetalhaCursoUC.DetalhandoCurso", form, 5));
