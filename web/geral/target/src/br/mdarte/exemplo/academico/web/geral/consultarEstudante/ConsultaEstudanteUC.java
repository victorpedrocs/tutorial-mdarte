...
public class ConsultaEstudanteUC extends br.mdarte.exemplo.academico.accessControl.Login2
{
	...
	public String particularExecute() throws Exception
	{
		...
		urlCasoDeUso = "/ConsultaEstudanteUC/ConsultaEstudanteUC";
		...
		final ConsultaEstudanteUCFormImpl specificForm = (ConsultaEstudanteUCFormImpl)form;
		...
		try
		{
			...
			org.andromda.presentation.bpm4struts.PageSessionObjectUtil.setPageSO(request, new org.andromda.presentation.bpm4struts.FormSessionObject("ConsultaEstudanteUC.PreenchaCampos", form, 5));
		...
		{
			Object formObj = org.andromda.presentation.bpm4struts.PageSessionObjectUtil.getPageForm(request, "ConsultaEstudanteUC");
	...
	public void loadUseCaseInfo()
	{
		...
		__urlCasoDeUso = "/ConsultaEstudanteUC/ConsultaEstudanteUC.action";
		__modulo = "geral";
		__contexto = "/geral";
	}
}
