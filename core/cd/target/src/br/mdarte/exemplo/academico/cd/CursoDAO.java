    ...
    extends AbstractDAO 
{
    ...
    public static java.util.Collection getEstudantesByCurso(long id , PaginationStrategy paginacao) throws DAOException {		
		...
		try {
			...
			org.hibernate.Query qry = session.createQuery("select elements(t1.estudantes) from br.mdarte.exemplo.academico.cd.Curso as t1 where t1.id = " + id);
