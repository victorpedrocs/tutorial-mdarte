...
public final class CriptoUtils {
	...
	static {
		...
		try {
			properties.load(new java.io.FileInputStream(new java.io.File((new java.net.URL(System.getProperty("jboss.server.config.url") + java.io.File.separator + "sistemaacademico-port.properties")).getFile())));
    ...
    * 'message.digest.algorithm' no arquivo 'sistemaacademico-port.properties'.
